...
speech = "Hi Harsha, I think this is your first time to use pip and modules in python, I wonder how you  feel about it?"
# selecting english language
language = 'en'
# setting text, language and voice speed 
obj = gTTS(text=speech, lang=language, slow=False)
